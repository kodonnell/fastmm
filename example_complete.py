...
print("=" * 70)
print("FASTMM Complete Example: Network Creation and Map Matching")
print("=" * 70)
...
config = fastmm.FastMapMatchConfig(k=4, candidate_search_radius=10.0, gps_error=5.0, reverse_tolerance=0.0)
    ...
    for i, segment in enumerate(result.segments):
        ...
        for edge in segment.edges:
            ...
            for j, point in enumerate(edge.points[:3]):
                print(
                    f"         Point {j}: ({point.x:.2f}, {point.y:.2f}), "
