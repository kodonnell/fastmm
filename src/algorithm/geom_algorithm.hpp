...
#ifndef FASTMM_GEOM_ALGORITHM_HPP
#define FASTMM_GEOM_ALGORITHM_HPP
...
namespace FASTMM
{
    ...
    namespace ALGORITHM
    {
         ...
         */
        std::vector<double> calculate_linestring_euclidean_distances(const FASTMM::CORE::LineString &trajectory);
         ...
         */
        void append_segs_to_line(FASTMM::CORE::LineString *line,
         ...
         */
        FASTMM::CORE::LineString reverse_geometry(const FASTMM::CORE::LineString &rhs);
         ...
         */
        std::vector<FASTMM::CORE::LineString> split_line(
         ...
         */
        FASTMM::CORE::LineString interpolate_line_distances(
         ...
         * @return a linestring containing the interpolated points
         */
        FASTMM::CORE::LineString interpolate_line_distance(
         ...
         * @return a linestring containing the interpolated points
         */
        FASTMM::CORE::LineString interpolate_line_kpoints(
            const FASTMM::CORE::LineString &line, int k);

        /**
         * Compute the boundary of an FASTMM::CORE::LineString and returns the result in
         ...
         */
        void boundingbox_geometry(const FASTMM::CORE::LineString &linestring,
         ...
         */
        std::vector<double> calc_length_to_end_vec(const FASTMM::CORE::LineString &geom);
        ...
        void linear_referencing(double px, double py,
                                const FASTMM::CORE::LineString &linestring,
                                double *result_dist,
         ...
         */
        void locate_point_by_offset(const FASTMM::CORE::LineString &linestring,
